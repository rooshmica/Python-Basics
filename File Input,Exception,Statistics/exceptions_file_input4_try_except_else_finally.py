...
else: # code to be executed if no exception encountered
    print("No problems encountered reading from file", filename)
finally: # code to be executed whether or not an exception was encountered
